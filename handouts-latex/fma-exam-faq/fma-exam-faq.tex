...
only. No calculus is required.} You take it \textbf{in person, on a computer, with a live proctor watching}, on a
...
heard of it, send them the AAPT link. Don't leave this until January. If your school says
no, you can ask teachers at other schools --- you do not have to test at your own. \\[3pt]
...
June &
Top scorers on the USAPhO are invited to the U.S. Physics Team training camp
...
easier --- go unread. Take a pass through the whole exam.
...
Bring your own scientific calculator. The proctor won't provide one. You cannot use a
graphing calculator like the TI-84.
...
\Q{Can I talk about the questions afterward?}
Not right away. Each exam carries an embargo: the 2025 exam told students not to
communicate anything about the questions or their solutions until after February 13, 2025 ---
the day after the exam. Solutions are posted publicly a few weeks later.

\section{Getting a Seat: Proctors, Registration, and Fees}

\Q{Who signs me up?}
\textbf{Your school registers you.} AAPT says ``It is preferred that one person
...
the exam.
\item \textbf{Not} a for-profit test prep center or educational service --- AAPT
...
\textbf{plus \$15.50 per student.}

\Q{Do I have to pay it?}
Often not. \textbf{Many schools cover the fee} out of a department or activities budget,
especially if a few students sign up together. Ask --- do not assume you will be billed.
...
\item \textbf{A community college or university.} Many have a testing center.
...
\Q{Will AAPT find me a proctor or a test center?}
...
and students could take both, but every year since has had a single exam. If you miss it,
you wait a year.
...
\textbf{Aim for 18 or higher on recent exams.} That clears every cutoff of the last several
years with room for a bad day.

One caveat when you practice with old exams: \textbf{the older exams are somewhat easier.}
On an exam more than about ten years old you should expect to score higher than 18 to
demonstrate the same level of performance that an 18 represents on a current exam. Don't
read a strong score on a 2011 exam as evidence you are already there.

It is also worth reading the medians in the table: 7 to 10 out of 25. \textbf{Half of
everyone who takes this exam scores single digits}, and those are self-selected students
who chose to take a physics olympiad qualifier. Qualifying means finishing in roughly the
top 7--9\% of that group. A score you might think of as mediocre --- 12, 13 --- is well
above the national median. Do not measure yourself against 25.
...
\Q{And after that?}
Top scorers on the USAPhO are invited to the training camp at the University of Maryland in
late May, and five students are eventually selected for the U.S. team at the International
Physics Olympiad. Some years AAPT also runs an additional exam, the USAPhO Plus, to help
make that selection.

\Q{What if I do not qualify?}
It's normal to take the exam more than once before moving on to the USAPhO. The exam is
offered every year, the scores in the table above tell you how selective it is, and the
ordinary path is to take it, see where you stand, and come back stronger. That is what the
practice tests and the handouts are for.
...
\item[$\square$] Know that blanks score zero, so make your best educated guess on any
