...
#let data = (
  ...
  sessions: (
    ("Aug 21, 2026", "First meeting, where we talked about the F=ma exam and got a sense of what she already knew.", "2011 F=ma; Blue Morin — Chapter 1"),
    ("Aug 27, 2026", "We used dimensional analysis to build the oscillation frequency of a water droplet out of surface tension, density, and radius, then practiced turning small percent changes into answers with the binomial approximation.", ""),
    ("Aug 28, 2026", "We worked through spring energy and simple harmonic motion, landing on why the period of a linear spring doesn't depend on amplitude, and then asked what changes when the restoring force isn't linear.", "AoPS Practice Exam 1"),
    ("Aug 31, 2026", "We calculated moments of inertia by integration, checked them against the parallel axis theorem, and used the results to say which shapes roll down an incline fastest.", "Blue Morin — Ch 7, read and multiple choice problems"),
    ("Sep 1, 2026", "We derived the acceleration of a rolling sphere and tested it in limiting cases, then estimated the tension in a biceps tendon during a curl at around 200 pounds using torque about the elbow.", "Rolling Without Slipping; Blue Morin — Read ch 8, no need to do the problems yet"),
    ...
    ("Sep 15, 2026", "We reviewed her practice F=ma exam, worked the physical pendulum and the swinging semicircular disc, and practiced eliminating answer choices with limiting cases instead of full calculations.", "F=ma Gravity & Kepler's Laws (online quiz) — Akshatha Arunkumar"),
  ),
)
