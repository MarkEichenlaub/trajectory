  ...
  return (
    <div className="assigned-view">
      ...
      {studentSessions.length === 0 && !editingId ? (
        <div className="empty-state">No sessions yet. Sessions will appear here automatically when booked via Cal.com, or add one manually.</div>
      ) : (
